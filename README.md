# Yang-Mills Existence and Mass Gap via Self-Adjoint Gauge Persistence
## Canonical Lane (defined term): the manifold-constrained local-to-global closure architecture (`YM1–YM8`) for the Yang-Mills mass-gap program.
